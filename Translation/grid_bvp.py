...
# Вы можете отправить несколько, чтобы указать значение для каждого параметра
# отдельно.
...
class grid_BVP:
                        ...
                        for ia in range(num_a):
                            for ik0 in range(num_k0):
                                ...
                                self.l_calc.update_params(R=self.rr[ir], 
                                        ...
                                        amp=self.amp[ia])
                                # Найти нули, которые решают нашу краевую задачу;
    ...
    def mcBVP(self):
        ...
        for ii in range(num):
            ...
            # Найти нули, которые решают нашу краевую задачу; это та часть, 
