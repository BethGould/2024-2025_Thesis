...
# Здесь содержится моя функция-оболочка для решения краевой задачи с помощью поиска
# нулей функции, линейные модели, которые будут использоваться с этой функцией-
# оболочкой, и пример кода для выполнения поиска нулей функции.
