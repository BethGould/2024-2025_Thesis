...
from eelib.grid_slow_osc import find_amp, find_root_start
from eelib.BVP_matching import find_root_both
from eelib.loop import loop
import matplotlib.pyplot as plt
from eelib.BVP_matching import fun, k_calc_0, pred_fast_k, M_calc_0
...
def test_match(dk, R2, B2, mu):
    ...
    # find the roots
    deriv_psi_o, xs_sol, deriv_psi, dpsi_sol = find_root_both(dk, R, B, mu, model_k=pred_fast_k, prep = 10, check_solution = True)
