# eelib/k_M_models_ivp.py
#
# Автор: Элизабет Гоулд
# Дата последнего изменения: 23.03.2026

# Здесь приведены модели для изменения частот обоих типов колебаний. Они
...
#   Это исходная модель для быстрых колебаний. Она такая же, как и 
...
#   Это то же самое, что и pred_slow_k. Текущая модель была третьей по
...
#   демонстрации кода извлечения модели.
...
# Эти словари являются жестко запрограммированными параметрами, которые уже
# были найден в числовом выражении. Они не используются за пределами приведенных
# здесь функций.
...
# Это старые, неудачные модели M, и поэтому они были удалены.
'''
...
# Модель для k (волнового числа быстрых колебаний) с удаленным ошибки. 
